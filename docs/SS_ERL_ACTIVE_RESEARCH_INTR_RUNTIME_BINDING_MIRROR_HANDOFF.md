...
## Pending proof-verifier hardening
...
The hardened verifier now fails closed unless:
...
1. Validate and merge the exact-byte proof-verifier hardening without weakening repository-wide validation.
