...
The reusable service-delivery carriage correction merged through StegVerse-Labs/.github PR #2222 at `f5c64120d381842db16ca1a5156bb881c8e383f8`. The neutral Healer/reusable-task path now reaches the released same-service installer instead of bypassing it with direct dispatcher activation. Authentic scheduler/reusable-task consumption and the resulting TVC restart/startup receipt remain unobserved.
