...
StegOS #351 owns a same-iPhone persistent browser-independent continuity carrier. Its handoff state remains runtime-unproven. This Goal does not make #351, NetworkExtension, TestFlight, a standing app, a second machine, or any specific platform carrier a prerequisite to ordinary StegBrowser execution.
...
This reconciliation advances the candidate registry from generation 26 to generation 27 while retaining `ACTIVE / CHECKED_OUT`.
