...
- Previously verified canonical registry generation: 220; branch proposes 221 **only if main has not changed**. Always re-read current main before review, validation or merge.
