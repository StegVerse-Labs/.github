...
- current source says the witness `/spec` route and consolidated reader-facing vocabulary were added in v1.3 after the v1.1 `confirmed` commitments and v1.2 rename, strongly corroborating the operator-disclosed historical vocabulary gap without excluding every possible external historical publication surface;
