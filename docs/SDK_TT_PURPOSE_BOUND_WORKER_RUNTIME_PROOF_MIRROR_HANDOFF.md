...
Related history is reconciled: SDK PR #266 merged the local-console implementation; SDK PR #267 merged its closeout; .github PR #2120 registered the console task; .github PR #2122 retired it and registered this runtime successor. No open related PR or issue was observed. Prior merged-work branch refs were aligned to current main.
