...
def main():
 ...
 packet=K.build_packet(origin_org="StegVerse-Labs",origin_service="stegverse-labs.org-control",destination_org="master-records",destination_service="master-records.ecosystem-transition-ledger",payload=payload,transition_reference="ecosystem.transition.custody.v1",authority_effect="NONE")
