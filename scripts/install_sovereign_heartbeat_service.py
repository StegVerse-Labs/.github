...
def materialize(source_root: Path, target_root: Path, *, interval_ms: float = DEFAULT_WORKER_INTERVAL_MS):
    ...
    required = (
        ...
        target_root / "scripts" / "run_sovereign_ephemeral_console.py",
        target_root / "scripts" / "dispatch_resident_execution_requests.py",
        target_root / "scripts" / "consume_resident_execution_request.py",
        target_root / "scripts" / "consume_kv_ai_memory_resident_request.py",
        target_root / "scripts" / "prepare_kv_ai_memory_intr_runtime_source.py",
        target_root / "scripts" / "install_kv_ai_memory_universal_intr_route.py",
        target_root / "scripts" / "submit_kv_ai_memory_packet_local.py",
