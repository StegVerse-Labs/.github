...
EXTRA=("scripts/consume_device_kv_intr_materialization_request_base.py","scripts/workspace_device_kv_query_extension.py","scripts/refresh_sovereign_worker_runtime_source_base.py","scripts/bootstrap_sovereign_runtime_base.py","scripts/install_sovereign_heartbeat_service_base.py")
