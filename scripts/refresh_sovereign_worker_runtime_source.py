...
STATIC_FILES = (
    ...
    Path("scripts/submit_kv_ai_memory_packet_local.py"),
    ...
    Path("scripts/consume_organization_custody_readback_request.py"),
    ...
    Path("scripts/evaluate_task_registry_ai_session_checkin.py"),
    ...
    Path("scripts/audit_task_registry_session_gate_backlog.py"),
    Path("data/task-registry-ai-ingress-policy.json"),
    ...
    Path("resident-runtime/organization_batch_custody.py"),
    Path("resident-runtime/organization_custody_readback.py"),
