...
EXTRA=(Path("scripts/consume_device_kv_intr_materialization_request_base.py"),Path("scripts/workspace_device_kv_query_extension.py"),Path("scripts/personal_profile_device_kv_extension.py"),Path("scripts/refresh_sovereign_worker_runtime_source_base.py"))
