...
NONSECRET_ENV = (
    ...
    "STEGVERSE_NODE_GENESIS_RECEIPT", "STEGVERSE_STEGOS_SOURCE_ROOT", "STEGVERSE_EPHEMERAL_RUNTIME_BASE",
...
def dispatch(source_root: Path, runtime_root: Path, *, runner=subprocess.run, env: Mapping[str, str] | None = None, only_consumers: tuple[str, ...] | None = None) -> dict[str, Any]:
    ...
    accepted_wait_states = {
        ...
        "A1_A2_A2_1_A2_2_A3_A4_OBSERVED", "A1_OBSERVED_CANONICAL_INVOCATION_PENDING_OR_BOUNDARY", "A1_OBSERVED_NOT_CALLABLE",
    }
