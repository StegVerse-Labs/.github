...
# Only outcomes proving that the exact StegBrowser request occupies the private-source
    ...
    *,
    ...
    receipt = {
        ...
        "target_consumption_receipt_path": (
            str(CANONICAL_GOAL_CONSUMPTION_REL[current_goal_task_id]) if canonical_goal_required
