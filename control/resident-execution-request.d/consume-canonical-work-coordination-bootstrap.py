...
def main() -> int:
    ...
    # Exact household Goal is already bound to the standing carrier. An
    # unrelated MIR subprocess must not consume its full timeout first.
    # Preserve MIR-first order for every other goal and unscoped cadence.
