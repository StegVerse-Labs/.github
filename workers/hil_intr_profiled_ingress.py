...
credentialless, non-authorizing profile/readiness surface. Public HTTPS is
terminated by the shared StegVerse Service Gateway; this listener remains
loopback unless explicit native TLS is configured for bounded observation.
"""
...
def main() -> int:
    ...
    host, port = serve(runtime_root=args.runtime_root, bind_host=args.bind_host,
                       bind_port=args.bind_port, max_requests=args.max_requests,
