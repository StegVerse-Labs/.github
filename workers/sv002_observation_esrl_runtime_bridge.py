...
def materialize_sv002_observation_runtime(
    *,
    control_root: Path,
    ...
    This bridge stops at LOCAL_READY and does not claim public route readiness,
    observation success, experiment interaction, custody, or Master Records state.
    """
    ...
    registry = {
        "schema": "stegverse.sv002-observation-esrl-consequence/v1",
    ...
    lease_id = "SV002-OBS-ESRL-" + hashlib.sha256(
    ...
    adapter = SovereignEphemeralNodeAdapter(
        ...
        runtime_base=intake_runtime_root / "esrl-sv002-observation-runtime",
