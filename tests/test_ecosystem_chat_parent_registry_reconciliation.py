...
class EcosystemChatParentRegistryReconciliationTests(unittest.TestCase):
    ...
    def test_canonical_registry_matches_post_recovery_parent_admission(self):
        ...
        self.assertGreaterEqual(
            admission["minimum_fencing_token_exclusive"],
            self.recovery["recovery_fencing_token"],
        )
    ...
    def test_fresh_parent_fence_floor_is_strictly_above_terminal_recovery(self):
        ...
        recovery_floor = self.recovery["recovery_fencing_token"]
        admission_floor = admission["minimum_fencing_token_exclusive"]
        handoff_floor = handoff_activation["minimum_fencing_token_exclusive"]
        self.assertGreaterEqual(admission_floor, recovery_floor)
        self.assertGreater(handoff_floor, recovery_floor)
        self.assertGreaterEqual(handoff_floor, admission_floor)
