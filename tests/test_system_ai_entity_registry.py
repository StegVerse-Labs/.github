...
class SystemAIEntityRegistryTests(unittest.TestCase):
    def test_registry_declares_stegverse_002_without_false_activation(self) -> None:
        ...
        self.assertEqual(registry["schema"], "stegverse.system-ai-entity-registry/v0.2")
        self.assertEqual(entity["schema"], "stegverse.system-ai-entity/v0.2")
        ...
        self.assertFalse(entity["activation"]["inference_execution_proven"])
        self.assertFalse(entity["activation"]["interaction_boundary_standing_proven"])
        self.assertNotIn("governed_inference_proven", entity["activation"])
