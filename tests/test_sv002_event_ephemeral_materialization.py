...
class SV002EventEphemeralTests(unittest.TestCase):
    ...
    def test_profile_preserves_hil_and_advertises_sv002(self):
        ...
        self.assertEqual(profile["profiles"], ["HIL:Ingress", "SV002:PublicObservation", "KV:KnowledgeVaultInterlock", "KV:SKAPCiphertextCustody", "Publisher:ArtifactTransfer", "KV:PublisherArtifactImport"])
